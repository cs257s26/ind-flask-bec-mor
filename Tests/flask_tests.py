...
class TestSOMETHING(unittest.TestCase):
    ...
    def test_route_column(self): 
        '''Tests whether a specified column returns the correct output'''
        self.app = app.test_client() 
        load_data()
    ...
    def test_route_nonexistent_column(self):
        '''Tests whether a nonexistent column returns an empty string'''
        self.app = app.test_client() 
        load_data()
    ...
    def test_route_row(self): 
        '''Tests whether a specified row returns the correct output'''
        self.app = app.test_client() 
        load_data()
    ...
    def test_route_nonexistent_row(self): 
        '''Tests whether a nonexistent row returns the correct error message'''
        self.app = app.test_client() 
        load_data()
